...
Примечание: программа написана в Intellij idea Community edition с использованием MySQL. Для корректной работы с базой данных необходимо установить плагин Database Navigator [следуя рекомендациям из этой статьи](https://habr.com/ru/sandbox/146588/), а так же отредактировать класс, содержащий логин и пароль для доступа к локальной бд. Далее необходимо будет запустить скрипт [MySQL script.sql](https://github.com/Minyosha/Animal_registry/blob/master/MySQL%20script.sql), который создаст таблицы в базе данных и наполнит их содержимым. После этого программа готова к работе.
